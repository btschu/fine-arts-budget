    ...
    <>
      ...
      {open && (
        <Modal title={memberName} onClose={close}>
          <p className="mb-4 text-sm text-slate-500 dark:text-neutral-400">{memberEmail}</p>
          <form
            action={(formData) => {
              setError(null);
          ...
          <div className="mt-6 border-t border-slate-200 pt-4 dark:border-neutral-800">
            ...
            {newPassword ? (
              <div className="rounded-md border border-emerald-200 bg-emerald-50 p-3 dark:border-emerald-900 dark:bg-emerald-950/40">
                <p className="mb-1 text-sm text-slate-700 dark:text-neutral-300">
                  New temporary password — share this with {memberName}:
                </p>
                <p className="select-all rounded bg-white px-2 py-1 font-mono text-sm text-slate-900 dark:bg-neutral-800 dark:text-neutral-100">
                  {newPassword}
                </p>
              </div>
            ) : (
              <button
                ...
                className="rounded border border-slate-300 px-3 py-1.5 text-sm text-slate-600 hover:bg-slate-50 disabled:opacity-60 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-800"
              >
